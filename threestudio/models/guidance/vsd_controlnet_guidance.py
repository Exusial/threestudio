...
@threestudio.register("vsd-controlnet-guidance")
class VSDControlNetGuidance(BaseModule):
    @dataclass
    ...
    def forward(
        ...
        cond_rgb: Float[Tensor, "B H W C"]=None,
        **kwargs,
    ):
        ...
        grad = self.compute_grad_vsd(
            latents, text_embeddings_vd, text_embeddings, camera_condition, image_cond
        )
        ...
        loss_lora = self.train_lora(latents, text_embeddings, camera_condition, image_cond)
